...
//    self.view.frame = CGRectMake(0, 0, kWidth, kHight);
...
//        
        ...
        self.qRScanView = [[LBXScanView alloc]initWithFrame:[[UIScreen mainScreen] bounds] style:_style];
        [self.view addSubview:_qRScanView];
        
    
        
        self.topTitle = [[UILabel alloc]init];
        _topTitle.bounds = CGRectMake(0, 10, 180, 60);
        _topTitle.center = CGPointMake(CGRectGetWidth(self.view.frame)/2, 60);
...
- (void)drawBottomItems
{
    ...
    self.bottomItemsView = [[UIView alloc]initWithFrame:CGRectMake(0, kHight-164,
...
{
    if (self.completion) {
        self.completion(strResult.strScanned,strResult);
    }
