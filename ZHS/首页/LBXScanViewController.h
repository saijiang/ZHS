...
@interface LBXScanViewController : TNViewController<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
/**
 @brief  扫码成功后要完成的任务Block形式封装
 */
@property (copy, nonatomic) void (^completion)(NSString *strScanned,LBXScanResult*strResult);
