...
"e|he", "shu", "cao", "cao", "sheng", "man", "zeng|ceng", "zeng|ceng", "ti", "cuo|zui", \
...
"tui", "han", "jing|ying", "ying", "ke|kuan", "di|ti", "yu|yong", "e", "zhuan", "ya|yan", \
...
int unichar2Py(unichar c, char* out, int *outlen) {
	if (c > 19967 && c < 40870) {
		const char *ch = _pinyin_table_[c - 19968];
...
char getpychar(const char *buffer, int bufferLen)
{
	char pychar;
	if (bufferLen < 2) {
		return -1;
